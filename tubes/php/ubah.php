          ...
          <table>
            <div class="4u 12u$(small)">
              <tr>
                ...
                <td>:</td>
                <td><input type="text" name="kode_barang" id="kode_barang" value="<?= $elektro['kode_barang']; ?>" autofocus autocomplete="off" required></td>
              </tr>
              <tr>
                <td>
                ...
                <p><img src="../assets/img/<?= $elektro['foto']; ?>" width="120" style="display: inline-block" class="img-preview"></p>
              </tr>
              <tr>
                <td>
                ...
                <td>:</td>
                <td><input type="text" name="nama" id="nama" value="<?= $elektro['nama']; ?>" required></td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  <select name="jenis_barang" id="jenis_barang">
                    <option value="<?= $elektro['jenis_barang']; ?>"><?= $elektro['jenis_barang']; ?></option>
              ...
              <tr>
                ...
                <td>:</td>
                <td><input type="text" name="harga" id="harga" value="<?= $elektro['harga']; ?>" required></td>
              </tr>
            </div>
          </table>
